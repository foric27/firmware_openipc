...
clk_cfg()
{
	if [ "$hw_chip" = "3516a" ]; then
		himm 0x20030030 0x00004025      # We have to change DDR speed to 250mhz on 655v/3516a
	else
		himm 0x20030030 0x00004005      # In other cases DDR works on 300mhz
	fi
